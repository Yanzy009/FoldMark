...
当前版本为 `0.1.2` 产品化候选版。源码层功能和自动构建基础已经建立；签名、公证及 Windows 10/11 实机体验属于正式发布前的外部验收门槛。详见 [RELEASE_CHECKLIST.md](RELEASE_CHECKLIST.md) 与 [WINDOWS_TEST.md](WINDOWS_TEST.md)。
